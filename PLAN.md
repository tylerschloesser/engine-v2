...
| [ ] | 16f | `16f-harness-waits-and-sibling-burst.md` | bound every `engine/test` harness wait; test the `gen` yield lead; attribute and fix the hardware slow tier's sibling-burst `main` rise | 16e | |

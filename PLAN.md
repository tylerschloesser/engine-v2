...
| [ ] | 16d | `16d-sim-pacing-under-external-wakes.md` | sim ticks steadily while a client wakes it every frame (amends 0030); `vertical_slice` under 3 s, time-independent pixel probe | 16c | |

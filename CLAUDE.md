...
| `docs/decisions/NNNN-<slug>.md` | ADRs 0001–0039 (index: `PRE-PLAN.md` §1, then `PLAN.md` "Plan-level decisions"): what was chosen and the *why* that can't be inferred from code | Permanent; supersede, don't rewrite |

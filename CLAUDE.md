...
| `docs/decisions/NNNN-<slug>.md` | ADRs 0001–0027 (index in `PRE-PLAN.md` §1): what was chosen and the *why* that can't be inferred from code | Permanent; supersede, don't rewrite |

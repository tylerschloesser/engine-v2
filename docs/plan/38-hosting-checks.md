...
- [ ] Deviations and the README hosting section both state that the static-host COOP/COEP listings (0015 §3) are unverified, and `39b-phase-4-handoff.md`'s open item still names it.

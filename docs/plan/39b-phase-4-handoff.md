...
- **Declare Phase 3 done.** Tick M39b in `PLAN.md`; commit; tell Tyler the branch is ready to merge. Never commit to `main` directly.
...
- [ ] `PLAN.md` is fully ticked; the working tree is clean; Tyler has been told the branch is ready.

...
- `loadGame(dir): Promise<{ wasm: WebAssembly.Module, buildHash: string }>` from `engine/server/node` (0017 §4). M27 extends this file; M35 adds the Bun and Deno files.

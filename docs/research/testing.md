...
- **Spike A:** feasible, no flakes (820/820 clean runs pass, 150/150 negative controls fail on the right isolate, ~0.3 s per test, real Metal device in headless Chromium). It supersedes this file's sampling interval and budgets. See `spikes/zero-gc-webgpu/RESULT.md`.
- **Spikes B and C:** not run; deferred with reasons in ADR 0020.
